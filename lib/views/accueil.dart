              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  var iosUrl = Uri.parse(
                      'https://apps.apple.com/ci/app/morning-glory-app/id6623925725');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        //       _cUser.user.code_famille,
        //       // "${formatSchoolName(widget.schoolid.toString())}-PAIE",
        //       maxFontSize: 16,
        //       minFontSize: 11,
        //       maxLines: 1,
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    Get.to(() => Operation(data: childrenData));
                                  },
                                  child: Card(
                                    color: Colors.white,
                                    elevation: 1.0,
