  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          var childrenData = {
            "nom": widget.paiementDetails!.nomEleve,
            "prenom": widget.paiementDetails!.prenomEleve,
            "matricule": widget.paiementDetails!.matricule,
            // "code_famille": widget.paiementDetails!.c,
            "classe": widget.paiementDetails!.classe,
            "date_naissance": widget.paiementDetails!.dateNaissance,
          };
