...
class GetSortieScolaire extends StatefulWidget {
  Map data;
  GetSortieScolaire({Key? key, required this.data}) : super(key: key);

  @override
  State<GetSortieScolaire> createState() => _GetSortieScolaireState();
}

class _GetSortieScolaireState extends State<GetSortieScolaire> {
  ...
  Future<List<Scolarite>> getMontant() async {
    ...
    var response = await http.post(
      Uri.parse(Api.getSortieScolaire),
      body: {
