...
class _SupportState extends State<Support> {
  ...
  Future<void> openWhatsappSuppport() async {
    ...
    Uri whatsappURlAndroid = Uri.parse(
        "https://wa.me/$whatsappTel?text=${Uri.parse("Bonjour, pouvez-vous m'aider svp ? Mon nom est ${_cUser.user.nom} ${_cUser.user.prenom}. L'école est : Pépinière - Pay")}");
  ...
  Future<void> _launchRating() async {
    final Uri url = Uri.parse(
        "https://play.google.com/store/apps/details?id=com.lkmdigital.saintefamille");
  ...
  Future<void> _launchFeedback() async {
    final Uri url = Uri.parse(
        "mailto:infos@lkmdigital.ci?subject=FeedBack Sainte Famille - Pay [${_cUser.user.telephone}]&");
    if (!await launchUrl(url)) {
      throw Exception('Could not launch $url');
    }
  }
